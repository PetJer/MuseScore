...
enum class Sid {
    ...
    organRegistrationFontFace,
    organRegistrationFontSize,
    organRegistrationLineSpacing,
    organRegistrationFontSpatiumDependent,
    organRegistrationMusicalSymbolsScale,
    organRegistrationFontStyle,
    organRegistrationColor,
    organRegistrationAlign,
    organRegistrationFrameType,
    organRegistrationFramePadding,
    organRegistrationFrameWidth,
    organRegistrationFrameRound,
    organRegistrationFrameFgColor,
    organRegistrationFrameBgColor,
    organRegistrationOffset,
    organRegistrationPlacement,
    organRegistrationPosAbove,
    organRegistrationPosBelow,
    organRegistrationMinDistance,
