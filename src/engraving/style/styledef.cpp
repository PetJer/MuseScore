...
const std::array<StyleDef::StyleValue, size_t(Sid::STYLES)> StyleDef::styleValues { {
   ...
   { Sid::organRegistrationFontFace,          "organRegistrationFontFace",          "Edwin" },
   { Sid::organRegistrationFontSize,          "organRegistrationFontSize",          10.0 },
   { Sid::organRegistrationLineSpacing,       "organRegistrationLineSpacing",       1.0 },
   { Sid::organRegistrationFontSpatiumDependent, "organRegistrationFontSpatiumDependent", true },
   { Sid::organRegistrationMusicalSymbolsScale, "organRegistrationMusicalSymbolsScale", 1.0 }, // percentage of the standard size
   { Sid::organRegistrationFontStyle,         "organRegistrationFontStyle",         int(FontStyle::Normal) },
   { Sid::organRegistrationColor,             "organRegistrationColor",             PropertyValue::fromValue(Color::BLACK) },
   { Sid::organRegistrationAlign,             "organRegistrationAlign",             Align(AlignH::HCENTER, AlignV::VCENTER) },
   { Sid::organRegistrationFrameType,         "organRegistrationFrameType",         int(FrameType::NO_FRAME) },
   { Sid::organRegistrationFramePadding,      "organRegistrationFramePadding",      0.2 },
   { Sid::organRegistrationFrameWidth,        "organRegistrationFrameWidth",        0.1 },
   { Sid::organRegistrationFrameRound,        "organRegistrationFrameRound",        0 },
   { Sid::organRegistrationFrameFgColor,      "organRegistrationFrameFgColor",      PropertyValue::fromValue(Color::BLACK) },
   { Sid::organRegistrationFrameBgColor,      "organRegistrationFrameBgColor",      PropertyValue::fromValue(Color::transparent) },
   { Sid::organRegistrationOffset,            "organRegistrationOffset",            PointF() },
   { Sid::organRegistrationPlacement,         "organRegistrationPlacement",         PlacementV::ABOVE },
   { Sid::organRegistrationPosAbove,          "organRegistrationPosAbove",          PointF(.0, -1.0) },
   { Sid::organRegistrationPosBelow,          "organRegistrationPosBelow",          PointF(.0, 2.5) },
   { Sid::organRegistrationMinDistance,       "organRegistrationMinDistance",       Spatium(.5) },
