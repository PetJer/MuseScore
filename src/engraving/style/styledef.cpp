...
const std::array<StyleDef::StyleValue, size_t(Sid::STYLES)> StyleDef::styleValues { {
    ...
    { Sid::organRegistrationFontSize,          "organRegistrationFontSize",          8.0 },
    { Sid::organRegistrationLineSpacing,       "organRegistrationLineSpacing",       0.8 },
    { Sid::organRegistrationFontSpatiumDependent, "organRegistrationFontSpatiumDependent", true },
    { Sid::organRegistrationMusicalSymbolsScale, "organRegistrationMusicalSymbolsScale", 1.0 },
    ...
    { Sid::organRegistrationAlign,             "organRegistrationAlign",             Align(AlignH::LEFT, AlignV::VCENTER) },
    { Sid::organRegistrationFrameType,         "organRegistrationFrameType",         int(FrameType::SQUARE) },
    { Sid::organRegistrationFramePadding,      "organRegistrationFramePadding",      1.0 },
