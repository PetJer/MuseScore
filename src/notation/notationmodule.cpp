...
#include "view/internal/organregistrationpopupmodel.h"
...
void NotationModule::registerUiTypes()
{
    ...
    qmlRegisterType<OrganRegistrationPopupModel>("MuseScore.NotationScene", 1, 0, "OrganRegistrationPopupModel");
